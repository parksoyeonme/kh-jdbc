...
public class MemberMenu {
		...
		switch(choice) {
         ...
         case 6: 
        	 result = memberController.deleteMember(inputMemberId());
				...
				break;
         case 7:
        	 list = memberController.selectDeletedMember();
        	 displayDelectMemberList(list);
        	 break;
         case 0: 
   ...
   private void displayDelectMemberList(List<Member> list) {
	   System.out.println("=======================================");
		//조회된 회원정보가 있을 때
		if(list != null && !list.isEmpty()) {
			System.out.println("memberId\tMemberName\tGender\tAge\tEmail\tPhone\tAddress\tHobby\tEnrollDate\tDel_date\tDel_flag");
			System.out.println("--------------------------------------------------------------------------------");
    ...
    */
	...
	private Member inputMember() {
		...
		return new Member(memberId, password, memberName, gender, 
                          age, email, phone, address, hobby, null,null,"N");
	}
	...
	public void displayError(String message) {
		System.err.println(message); //err객체를 통해 출력해서 빨간줄로 출력된다
